...
#define WIFI_SECRET_SSID "YOUR_SECRET_SSID"
#define WIFI_SECRET_PASS "YOUR_SECRET_PASSWORD"
...
#define SECRET_TOKEN  "THINGSBOARD_DISPOSIFITF_TOKEN"
#define SECRET_DEVICE_ID "THINGSBOARD_DISPOSIFITF_TOKEN"
